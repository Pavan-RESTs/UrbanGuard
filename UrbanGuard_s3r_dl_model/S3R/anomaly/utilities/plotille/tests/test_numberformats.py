...
def test_large_int():
    ...
    assert '1.235e+09' == _num_formatter(1234567890, chars=9, delta=0)  
...
def test_large_neg_int():
    ...
    assert '-1.235e+09' == _num_formatter(-1234567890, chars=10, delta=0)   
...
def test_floats():
    ...
    assert '12340000.6' == _num_formatter(12340000.56, chars=10, delta=0)  
...
def test_neg_floats():
    ...
    assert ' -12340001' == _num_formatter(-12340000.56, chars=10, delta=0)  
    assert '-123400001' == _num_formatter(-123400000.56, chars=10, delta=0)
